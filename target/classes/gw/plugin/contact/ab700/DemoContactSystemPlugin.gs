...
class DemoContactSystemPlugin implements ContactSystemPlugin {
  ...
  public static var DEMOCONTACT_FAXPHONE : String = "213-284-3649"
  public static var DEMOCONTACT_WORKPHONE : String = "201-543-8506"
  public static var DEMOCONTACT_HOMEPHONE : String = "805-392-7973"
  ...
  private static var _mapper = ContactIntegrationXMLMapper.getInstance()
  ...
  override function retrieveContact(contactUid: String, creator : ContactCreator) : Contact {
    ...
    var contactType = ContactIntegrationXMLMapper.getInstance().getNameMapper().getEntityNameFromXSDType(mockContact.EntityType)
  ...
  private function createSoapAddress(i : String) : XmlBackedInstance {
    var address =  new Address() {
       ...
       :State = "AR",
       :AddressType = "billing",
       :AddressBookUID = "mockAddr:${i}"
     }
    return _mapper.createAddressXMLFromAddress(null, address)
  }
  ...
  private function createAddressInfo(i : String) : AddressInfo {
    return new AddressInfo() {
      ...
      :PostalCode = "34546",
      :City = "City",
      :Country = wsi.remote.gw.webservice.ab.ab700.abcontactapi.enums.Country.US.GosuValue,
      :County = "County",
      :State = wsi.remote.gw.webservice.ab.ab700.abcontactapi.enums.State.AR.GosuValue,
      :AddressType = "Billing"
    }
  }
}
