...
@Deprecated("As of 8.0 use gw.webservice.pc.pc800.gxmodel.BusinessAutoLineModelEnhancement instead")
enhancement BusinessAutoLineModelEnhancement : gw.webservice.pc.pc700.gxmodel.businessautolinemodel.types.complex.BusinessAutoLine {
  ...
  function populate(line : BusinessAutoLine){
    ...
    for(v in this.Vehicles.Entry){
      ...
      MonetaryAmountAwareValuePopulator.populate(v.$TypeInstance, vehicle)
  ...
  private function populateClause(j : BAJurisdiction, cov : gw.webservice.pc.pc700.gxmodel.clausemodel.types.complex.Clause){
