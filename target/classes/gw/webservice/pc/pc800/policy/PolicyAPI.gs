...
uses gw.webservice.pc.pc800.gxmodel.activitymodel.types.complex.Activity
...
@WsiWebService( "http://guidewire.com/pc/ws/gw/webservice/pc/pc800/policy/PolicyAPI" )
@Export
class PolicyAPI {
