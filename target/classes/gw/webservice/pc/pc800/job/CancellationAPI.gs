 ...
 */
@WsiWebService( "http://guidewire.com/pc/ws/gw/webservice/pc/pc800/job/CancellationAPI" )
@Export
  ...
  function rescheduleCancellation(jobNumber : String, newCancellationDate : Date, newDescription : String, transactionId : String) : String {
    return SOAPUtil.tryCatch(\ bundle -> {
      ...
      if (cancellation == null) {
        throw new EntityStateException(displaykey.CancellationAPI.Error.InvalidJobNumber(jobNumber))
      }
