...
uses gw.webservice.pc.pc700.gxmodel.policylocationmodel.anonymous.elements.PolicyLocation_TerritoryCodes_Entry

@Deprecated("As of 8.0 use gw.webservice.pc.pc800.gxmodel.PolicyLocationModelEnhancement instead")
enhancement PolicyLocationModelEnhancement : gw.webservice.pc.pc700.gxmodel.policylocationmodel.types.complex.PolicyLocation {
  ...
  function copy(location : PolicyLocation) : gw.webservice.pc.pc700.gxmodel.policylocationmodel.types.complex.PolicyLocation {
